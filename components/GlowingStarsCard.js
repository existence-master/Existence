...
export const GlowingStarsBackgroundCard = ({ className, children }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "bg-black p-4 max-w-md max-h-[20rem] h-full w-full rounded-xl border border-[#eaeaea] dark:border-neutral-600",
        className
      )}
    >
...
export const GlowingStarsDescription = ({ className, children }) => {
  return (
    <p
      className={cn(
        "text-base font-mono text-white xs:max-w-[20rem] md:max-w-[24rem] md:mt-2 xs:mt-1",
        className
      )}
    >
      {children}
...
export const GlowingStarsTitle = ({ className, children }) => {
  return (
    <h2
      className={cn("font-bold font-mono text-2xl text-[#eaeaea]", className)}
    >
      {children}
    </h2>
  );
