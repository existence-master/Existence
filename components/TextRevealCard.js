      ...
      <div className="xs:max-md:h-10 h-40 relative flex items-center overflow-hidden">
        ...
        >
          <p
            ...
            className="text-base sm:text-[3rem] py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300 font-mono"
          >
            {revealText}
          </p>
        </motion.div>
...
export const TextRevealCardDescription = ({ children, className }) => {
  return (
    <p className={twMerge("text-[#a9a9a9] text-sm font-mono", className)}>
      {children}
    </p>
  );
};
